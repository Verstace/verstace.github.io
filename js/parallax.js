...
function toggleElems() {
	...
	$(document).on('click', function (e) {
		if (!$(e.target).closest('[data-toggle]').length && !$(e.target).closest('[data-toggle-elem]').length && !$(e.target).is('[data-toggle]') && !$(e.target).is('[data-toggle-elem]') || $(e.target).closest('[class*="close"]').length) {
			closeToggles();
		}
	});
